...
class AddEmpLogIn extends StatefulWidget {
  final Emp_Login emp_login;
  AddEmpLogIn(this.emp_login);

  @override
  State<StatefulWidget> createState() => _AddEmpLogInState(emp_login);
}

class _AddEmpLogInState extends State<AddEmpLogIn> {
  Emp_Login emp_login;
  _AddEmpLogInState(this.emp_login);
